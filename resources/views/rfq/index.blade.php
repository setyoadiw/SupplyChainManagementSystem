...
<div class="nav-scroller bg-white shadow-sm">
  <nav class="nav nav-underline">
    <a class="nav-link" href="{{route('createrfq')}}">Create RFQ</a>
    <a class="nav-link" href="{{route('createproduk')}}">Create Product</a>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
  ...
  <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('purchase')}}">Purchase Order</a>
      </li>
...
@section('content')
  ...
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    <h6 class="border-gray pb-2 mb-0">Request for Quotation</h6>
  ...
  @foreach ($rfq as $data)
    <tr>
    <th scope="row">#</th>
      <th scope="row">{{$data->vendor}}</th>
      <th scope="row">{{$data->vendorreference}}</th>
      <th scope="row">{{$data->created_at}}</th>
      <th scope="row">{{$data->scheduledate}}</th>
